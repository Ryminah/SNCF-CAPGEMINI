...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('sg_limvit', function (Blueprint $table) {
            $table->id('id', true);
            $table->integer('id_objet')->nullable();
            $table->string('imu', 46)->nullable();
            ...
            $table->integer('indication')->nullable();
            ...
            $table->spatialIndex(['geom'], 'sg_limvit_geom_idx');
